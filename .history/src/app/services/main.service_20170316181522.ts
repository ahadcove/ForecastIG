...
getMoreInfo(findDay){
  var ultraPack={
    ...
    ultraPack.temp.high = this.apiObj.list[findDay].main.temp_max;
    ultraPack.temp.low = this.apiObj.list[findDay].main.temp_max;
    ultraPack.temp.reg = this.apiObj.list[findDay].main.temp;
    ...
    ultraPack.city = this.apiObj.list[findDay].main.temp_max;
