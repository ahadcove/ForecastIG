...
fillTemps(thisDay){
  var tempPack=[
   ...
   tempPack[0].icon = this.apiObj.list[thisDay].main.temp;
   tempPack[0].weather = this.apiObj.list[thisDay].main.temp;
   tempPack[0].weatherDesc = this.apiObj.list[thisDay].main.temp;
   tempPack[0].reg = this.apiObj.list[thisDay].main.temp;
   tempPack[0].high = this.apiObj.list[thisDay].main.temp_max;
   tempPack[0].low = this.apiObj.list[thisDay].main.temp_max;
  return tempPack;
}
