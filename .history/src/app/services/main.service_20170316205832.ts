...
fillTemps(thisDay){
  ...
  var tempPack=[
   ...
   var icon = this.apiObj.list[thisDay].weather[0].icon;
   tempPack[0].time = this.apiObj.list[thisDay].dt;
   tempPack[0].icon = `http://openweathermap.org/img/w/`+icon+'.png';
   tempPack[0].weather = this.apiObj.list[thisDay].weather[0].main;
   tempPack[0].weatherDesc = this.apiObj.list[thisDay].weather[0].description;
   tempPack[0].reg = this.apiObj.list[thisDay].main.temp;
   tempPack[0].high = this.apiObj.list[thisDay].main.temp_max;
   tempPack[0].low = this.apiObj.list[thisDay].main.min;
  return tempPack;
}
