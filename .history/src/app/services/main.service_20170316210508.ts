...
fillTemps(thisDay){
  ...
  for(var i = 0;i<3;i++){
      ...
      var icon = this.apiObj.list[currIndex].weather[0].icon;
      tempPack[0].time = this.apiObj.list[currIndex].dt;
      tempPack[0].icon = `http://openweathermap.org/img/w/`+icon+'.png';
      tempPack[0].weather = this.apiObj.list[currIndex].weather[0].main;
      tempPack[0].weatherDesc = this.apiObj.list[currIndex].weather[0].description;
      tempPack[0].reg = this.apiObj.list[currIndex].main.temp;
      tempPack[0].high = this.apiObj.list[currIndex].main.temp_max;
      tempPack[0].low = this.apiObj.list[currIndex].main.min;
