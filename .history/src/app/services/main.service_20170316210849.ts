...
fillTemps(thisDay){
  ...
  console.log(`On Day ${thisDay} at index ${this.list.findIndex(thisDay)}`);
  var currIndex = this.list.findIndex(thisDay);
  var tempPack=[];
  ...
  for(var i = 0;i<3;i++){
      ...
      tempPack[0].time = this.apiObj.list[nextIndex].dt;
      tempPack[0].icon = `http://openweathermap.org/img/w/`+icon+'.png';
      tempPack[0].weather = this.apiObj.list[nextIndex].weather[0].main;
      tempPack[0].weatherDesc = this.apiObj.list[nextIndex].weather[0].description;
      tempPack[0].reg = this.apiObj.list[nextIndex].main.temp;
      tempPack[0].high = this.apiObj.list[nextIndex].main.temp_max;
      tempPack[0].low = this.apiObj.list[nextIndex].main.min;
